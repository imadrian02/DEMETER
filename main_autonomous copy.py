...
def display_frame():
    while True:
        if weed_frame is not None:
            ...
            cv2.imshow("Output2", weed_frame)
            cv2.imshow("Output3", masked_frame)
            cv2.imshow("Output4", output)
            cv2.imshow("Output5", thresholdOut)
...
try:
    while True:
        ...
        frame = cv2.imread(r"C:\Users\adria\DEMETER\Screenshot 2024-10-12 195623.png")
